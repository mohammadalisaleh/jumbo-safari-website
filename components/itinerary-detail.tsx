...
interface ItineraryDetailProps {
  itinerary: Itinerary
  /** Absolute path of this page, e.g. /itineraries/8-day-classic-tanzania-safari */
  canonicalPath: string
  related: Itinerary[]
  /** Custom sections rendered between Pricing and the additional sections (e.g. fee tables). */
  extraSections?: ReactNode
}

export function ItineraryDetail({ itinerary, canonicalPath, related, extraSections }: ItineraryDetailProps) {
  const canonicalUrl = `https://www.jumbosafaris.com${canonicalPath}`
  ...
  const touristTripSchema = {
    ...
    offers: {
      "@type": "Offer",
      price: String(itinerary.pricing?.fromPrice ?? itinerary.price.replace(/[^0-9]/g, "")),
      priceCurrency: "USD",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: itinerary.title, item: canonicalUrl },
    ],
  }
        ...
        <div className="max-w-content mx-auto px-6 pb-16 md:pb-24">
          <div className="grid lg:grid-cols-[1fr_380px] gap-12 [&>*]:min-w-0">
            ...
            <div>
              ...
              {/* Page-specific extra sections (fee tables, drive times, etc.) */}
              {extraSections}
