...
const page = getMonthPage("september")!

export const metadata: Metadata = {
  title: page.metaTitle ?? page.title,
  description: page.metaDescription ?? page.description,
  alternates: { canonical: "https://www.jumbosafaris.com/safari-in-september" },
  openGraph: {
    title: `${page.title} | Jumbo Safaris`,
    description: page.metaDescription ?? page.description,
    url: "https://www.jumbosafaris.com/safari-in-september",
  },
}
...
export default function SafariInJulyPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: page.title, item: "https://www.jumbosafaris.com/safari-in-september" },
    ],
  }
            ...
            <aside className="lg:self-start lg:sticky lg:top-24">
              ...
              <div className="bg-forest text-cream p-6 mb-6">
                ...
                <p className="text-sm text-cream/80 mb-4">
                  {page.month} books fast. Get your dates secured with a free, no-pressure itinerary from Arusha.
                </p>
                <Link
                  href="/contact"
