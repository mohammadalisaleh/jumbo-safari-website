...
const page = getMonthPage("october")!

export const metadata: Metadata = {
  title: page.metaTitle ?? page.title,
  description: page.metaDescription ?? page.description,
  alternates: { canonical: "https://www.jumbosafaris.com/safari-in-october" },
  openGraph: {
    title: `${page.title} | Jumbo Safaris`,
    description: page.metaDescription ?? page.description,
    url: "https://www.jumbosafaris.com/safari-in-october",
  },
}
...
export default function SafariInJulyPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: page.title, item: "https://www.jumbosafaris.com/safari-in-october" },
    ],
  }
