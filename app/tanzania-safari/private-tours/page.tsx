  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: { "@type": "Answer", text: "Private Tanzania safaris start from $2,445 per person for a 5-day northern circuit based on two adults sharing in the Comfort tier, dropping to around $1,345 per person for a group of six in green season. An 8-day classic safari is from $3,580 per person for two sharing. Prices use real lodge rates and current park fees, which are included throughout. Larger groups pay less per person because the private vehicle and guide are shared. Solo travellers pay a single supplement of approximately 30 to 40 percent on top of the per-person rate." },
      },
      {
        "@type": "Question",
